...
def get_token(dcityname, acityname):
    dcity = city_infos.get(dcityname)
    acity = city_infos.get(acityname)
    et = execjs.compile("""
    function getProductToken(e, t, n) {
        return v(e + t + n + "duew&^%5d54nc'KH")
    }
    ...
    """)
    return et.call("getProductToken", dcity, acity, 'Oneway')
